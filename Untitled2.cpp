...
void imp_tabla(int[3][14], int, char[3], char[3]);
void imp_dados(int[]);
void imp_reng(int);
void dado1(int);
void dado2(int);
...
int main(){
    ...
    char aka1[4], aka2[4];
    int cjug, ronda = 0, r = 1,reserva, cuantos_guard, YH1 = 0, YH2 = 0;
    iniciador(puntajes);
    ...
    cout << "Cuantos jugadores van a jugar? 1 o 2 :";
    ...
    if (cjug > 1){
        cout << "Jugador 1, introduce tu nombre: "; cin >> J1;
        cout << "Jugador 2, introduce tu nombre: "; cin >> J2;
    }
    else{
        cout << "Introduce tu nombre: "; cin >> J1;
    }
    ...
    do{
        ...
        if(cjug == 2 && ronda % 2 == 0){
            ...
            imp_tabla(puntajes, cjug, aka1, aka2);
            cout << "Para continuar presiona enter..."; getchar();
        }
        else if(cjug == 1){
            r += 1;
        }
...
void capturador(int para_capturar[], int tama){
    ...
    for (int i = 0; i < tama; ++i) {
        ...
        aux[ac] = para_capturar[x-1];
        ac += 1;
    }

    for (int i = 0; i < tama; ++i) {
        para_capturar[i] = aux[i];
    }
}

void impresora_tabla(int tabla[][14]){
    for (int i = 0; i < 3; ++i) {
        for (int j = 0; j < 14; ++j) {
            cout <<"  "<<tabla[i][j];
        }
...
void pantalla_salida(){
    ...
    cout << " ________  ________  _____ ______   _______           ________  ___      ___ _______   ________     \n"
            ...
            "                                                                                                    ";
    cout << "Presiona enter para conocer al ganador..."; getchar();
}

void imp_tabla(int tabla[3][14], int jugadores, char apodo1[3], char apodo2[3]){
    cout << endl <<"+---------+-------+";
    if(jugadores == 2){
        cout << "-------+";
    }
